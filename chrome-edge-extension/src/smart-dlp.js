...
class SmartEnterpriseDLP {
  ...
  createTokenElement(replacement, tokenId) {
    console.log(`Smart DLP: Creating interactive token element for: ${replacement}`);
    ...
    useOriginalBtn.addEventListener('click', (e) => {
      ...
      tooltip.style.display = 'none';
      console.log(`Smart DLP: Used original value for ${replacement}`);
    });
    ...
    removeBtn.addEventListener('click', (e) => {
      ...
      console.log(`Smart DLP: Removed token ${replacement}`);
    });
      ...
      if (data) {
        ...
        if (editor.tagName === 'INPUT' || editor.tagName === 'TEXTAREA') {
          ...
          if (currentText.includes(malformedMarker)) {
            ...
            console.log(`Smart DLP: Could not find target text to replace for ${data.pattern.name}`);
          }
          ...
          if (currentHTML.includes(malformedMarker)) {
            // Replace malformed marker in HTML
